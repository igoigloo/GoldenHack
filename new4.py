...
# Buttons to display data visualizations
if st.button("Show Permanent Residents Data"):
    st.subheader("Permanent Residents Data Visualization")
    ...
    with fig_col1:
        # Permanent resident by countries
        PRc = PRc.sort_values(by='Count', ascending=True)
        st.markdown("### Population Density via Ethnicity in Permanent Residents (by Country)")
    ...
    with fig_col2:
        # Permanent resident by regions
        st.markdown("### Population Density via Ethnicity in Permanent Residents (by Region)")
        st.write("This bar chart compares the 'Count' and 'Base Count' variables from the dataset.")
...
if st.button("Show Temporary Residents Data"):
    st.subheader("Temporary Residents Data Visualization")
    PRc = pd.read_excel("Datasets/2Permanent_Resident_-_Country_of_Citizenship copy.xlsx")
    PRr = pd.read_excel("Datasets/2Permanent_Resident_-_Region_of_Citizenship.xlsx")
    TRc = pd.read_excel("Datasets/2Temporary_Resident_-_Country_of_Citizenship.xlsx")
    TRr = pd.read_excel("Datasets/2Temporary_Resident-_Region_of_Citizenship.xlsx")
    ...
    with fig_col1:
        ...
        st.markdown("### Population Density via Ethnicity in Temporary Residents (by Region)")
        st.write("This bar chart compares the 'Count' and 'Base Count' variables from the dataset.")
    ...
    with fig_col2:
        ...
        st.markdown("### Population Density via Ethnicity in Temporary Residents (by Country)")
        st.write("This bar chart compares the 'Count' and 'Base Count' variables from the dataset.")
